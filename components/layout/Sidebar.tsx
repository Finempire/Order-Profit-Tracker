...
const navItems: NavItem[] = [
  ...
  { href: "/requests",  label: "Purchase Requests", icon: ClipboardList,   roles: ["ADMIN", "CEO", "ACCOUNTANT", "PRODUCTION"],  color: "text-amber-500",   activeBg: "bg-amber-50",   activeBgDark: "dark:bg-amber-500/20" },
